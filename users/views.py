...
from .formas import SignupForm,UpdateProfileForm
...
class AddRemuveSavedView(LoginRequiredMixin,View):
    login_url='login'
...
class SevedView(LoginRequiredMixin,View):
    login_url= 'login'
    def get(self,request):
        ...
        return render(request,'saveds.html',{'saved':saveds})
    

class RecentlyViwedView(View):
    def get(self,request):
